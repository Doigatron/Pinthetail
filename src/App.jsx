...
export default function App() {
  return (
    <div>
      <header style={{ backgroundColor: '#f4694c', color: '#fff', padding: '2rem', textAlign: 'center' }}>
        <h1>Pin the Tail</h1>
      ...
      <main style={{ padding: '2rem' }}>
        ...
        <section>
          ...
          <a style={{ backgroundColor: '#f4694c', color: 'white', padding: '1rem 1.5rem', borderRadius: '8px', textDecoration: 'none', fontWeight: 'bold' }} href="https://forms.gle/your-real-form-link" target="_blank" rel="noopener noreferrer">
            Join the Waitlist
          </a>
        </section>
      </main>
